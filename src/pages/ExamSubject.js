...
export default function ExamSubject() {
  ...
  const filteredUsers = applySortFilter(allSubjects, getComparator(order, orderBy), filterName);
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    console.log({ row });
                    const { id, boardName, mediumName, grade, subjectGroup, subjectName } = row;

...
export default function GeoHierarchicalDistrict() {
                ...
                <Container>
                    <Box sx={{ background: 'white', borderRadius: '13px', padding: '15px' }}>
                        <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                            ...
                            <div>
                                <Dialog fullWidth open={openDistrict} onClose={() => setOpenDistrict(false)}>
                                    ...
                                    <DialogActions>
                                        <Button onClick={() => setOpenDistrict(false)}>Cancel</Button>
                                        <Button onClick={() => setOpenDistrict(false)}>Add</Button>
                                    </DialogActions>
                                </Dialog>
                            </div>
                        </Grid>
